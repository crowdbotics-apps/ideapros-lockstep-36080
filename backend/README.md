...
## Project Structure
    ...
    ├── ideapros_lockstep_36080  # Django project configurations
...
1. Clone this repo and `cd ideapros_lockstep_36080`
...
2. Clone this repo and `cd ideapros_lockstep_36080`
